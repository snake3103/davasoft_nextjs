...
import { ShieldCheck, Save, ArrowLeft, X } from "lucide-react";
...
export default function NuevoImpuestoPage() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (res.ok) {
        showToast("success", "Impuesto creado exitosamente");
      ...
      <div className="max-w-3xl mx-auto space-y-8">
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="flex-1">
            <h1 className="text-2xl font-bold text-slate-800">Nuevo Impuesto</h1>
            <p className="text-slate-500 text-sm">Crea un nuevo impuesto para aplicar en tus facturas.</p>
          </div>
        </div>
