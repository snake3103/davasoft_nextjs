...
export function ContactForm({ initialData, action, title }: ContactFormProps) {
    ...
    return (
        <div className="max-w-4xl mx-auto space-y-6 pb-20">
            <form action={formAction}>
                ...
                <div className="bg-white rounded-3xl border border-border shadow-sm overflow-hidden p-8 space-y-8">
                    {/* Type Selection */}
