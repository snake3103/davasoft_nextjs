...
import { useClients, useProducts, useCreateInvoice, useUpdateInvoice } from "@/hooks/useDatabase";
import { invoiceSchema } from "@/lib/schemas/invoice";
import { ContactSearch } from "@/components/ui/Autocomplete";

// ─── Product Autocomplete (Reused from Modal) ──────────────────────────────────
        ...
        <div className="max-w-5xl mx-auto space-y-6 pb-20">
            ...
            <div className="flex items-center justify-between mb-8">
                ...
                <div className="flex gap-3">
                    ...
                    >
                        {createInvoice.isPending || updateInvoice.isPending ? <Loader2 size={16} className="animate-spin" /> : <Save size={16} />}
                ...
                <div className="p-8 space-y-8">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div className="space-y-2">
                            ...
                            />
                            {errors.clientId && <p className="text-xs text-rose-500 mt-1">{errors.clientId[0]}</p>}
                        </div>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="border border-border rounded-2xl overflow-hidden">
                            ...
                            <div className="divide-y divide-border">
                                {formData.items.map((item: any, index: number) => (
                                    <div key={index} className="grid grid-cols-12 gap-2 p-4 items-center animate-in slide-in-from-top-1">
                        ...
                        {errors.items && <p className="text-xs text-rose-500">{errors.items[0]}</p>}
                    </div>
